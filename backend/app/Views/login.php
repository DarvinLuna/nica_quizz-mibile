<html lang="zxx">
   ...
   <body class="crm_body_bg" style="margin-top: 8%;">
      ...
      <div id="back-top" style="display: none;">
         <a title="Go to Top" href="login.html#">
      ...
      <script src="../js/custom.js"></script>
        ...
        <script>
            ...
            $(".btn_1").on("click", function(e){
                ...
                const identifier = $("input[type='text']").val().trim();
                ...
                $.ajax({
                    url: "/auth/login",        // ajusta la URL a tu endpoint real
                    method: "POST",
                    contentType: "application/json",
                    data: JSON.stringify({ identifier, password }),
                    success: function(resp){
                        if(resp.ok){
                        alert("Bienvenido " + resp.user.display_name);
                        // Redirigir al dashboard o página inicial
                        window.location.href = "/dashboard";
                        } else {
                        alert(resp.error || "Error en inicio de sesión");
                        }
                    },
                    error: function(xhr){
